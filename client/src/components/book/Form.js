...
class Form extends Component {
  ...
  render() {
    ...
    return <form onSubmit={handleSubmit}>
      ...
      <Field component={this.renderField} name="author" type="text" placeholder="The author of this book." />
      <Field component={this.renderField} name="publicationDate" type="dateTime" placeholder="The publication date of this book." />
